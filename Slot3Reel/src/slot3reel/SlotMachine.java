...
/**
 * To create a virtual slot machine
 *
...
//        }
    ...
    /**
     * Prints a string that gives the rules and welcomes the user
     */
    private void intro() {
        System.out.printf("%s", "Greetings Jack\nWelcome to 3-Reel Slot Machine\n"
                ...
                + "2) Left-Double  : the left symbol matches either of the two "
                + "other symobls\n"
    ...
    /**
     * Prints a string that says goodbye to the user
     */
    ...
    private int readBet() {
        ...
        System.out.printf("\n%d\n%s", credit(), "How many coins do you want to "
                + "bet? (0 to quit)\n");
    ...
    /**
     * Determines whether if a bet exceeds credit and ask the user to give a
     * proper bet
     *
     * @return a proper bet
     */
    private int readDeposit() {
        ...
        if (currentBet > credit() || currentBet < 0) {
            System.out.printf("Insufficient credits -> (Credits = %d) but (Bet "
                    + "= %d)\n", credit(), currentBet);
            System.out.printf("To continue playing you must deposit at least "
                    + "%d\n", currentBet - credit());
